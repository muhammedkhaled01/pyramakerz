            ...
            <li class="nav-item">
                ...
                <div id="collapseProducts" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('products.index') }}">My products</a>
                        <a class="collapse-item" href="{{ route('product-uploaded') }}">Uploaded products</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('order-completed') }}">Completed</a>
                        <a class="collapse-item" href="{{ route('order-processing') }}">Processing</a>
                        <a class="collapse-item" href="{{ route('order-pending') }}">Pending</a>
                        <a class="collapse-item text-danger" href="{{ route('order-cancelled') }}">Cancelled</a>
